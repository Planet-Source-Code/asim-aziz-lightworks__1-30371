...
'To vote for the code Goto http://www.planetsourcecode.com/xq/ASP/txtCodeId.30371/lngWId.1/qx/vb/scripts/ShowCode.htm
...
Do While DoExplosion
    ...
    ExpSize = 10 + (MAXPARTICLES / 30) * Rnd
    R = 155 + 100 * Rnd
    G = 155 + 100 * Rnd
    B = 155 + 100 * Rnd
    Color = RGB(R, G, B)
